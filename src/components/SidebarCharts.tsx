...
import { Bitcoin, TrendingUp, TrendingDown, LineChart, Droplets, Landmark, Gauge } from 'lucide-react';
...
function formatMempoolFee(value: number | null): string {
  return value === null ? '—' : `${value.toFixed(value >= 10 ? 0 : 1)} sat/vB`;
}
